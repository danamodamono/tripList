...
import 'package:trip_list/view/area/prefectures/hokkaido/edit_screens/hokkaido_gurume_edit_screen.dart';
import 'package:trip_list/parts/confirm_dialog.dart';

class HokkaidoGurume extends StatefulWidget {
  @override
  _HokkaidoGurumeState createState() => _HokkaidoGurumeState();
}

class _HokkaidoGurumeState extends State<HokkaidoGurume> {
  ...
  _addNewWord() {
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => HokkaidoGurumeEditScreen(
              status: EditStatus.ADD,
            )));
  }

  void _getAllWords() async{
    _placeList = await database.hokkaidoGurumeSelect;
    setState(() {});
  }
